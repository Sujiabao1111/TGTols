...
-- Records of game_types
-- ----------------------------
INSERT INTO `game_types` VALUES (1, 'Slots (老虎机)', 2, 'SLOT');
INSERT INTO `game_types` VALUES (2, 'Live Casino (真人)', 3, 'CASINO');
INSERT INTO `game_types` VALUES (3, 'Sports (体育)', 4, 'SPORTBOOK');
INSERT INTO `game_types` VALUES (4, 'Keno', 5, 'KENO');
INSERT INTO `game_types` VALUES (5, 'Lottery', 6, 'LOTTERY');
INSERT INTO `game_types` VALUES (6, 'Fishing(捕鱼)', 7, 'FISHING');
INSERT INTO `game_types` VALUES (7, 'Esport(电竞)', 8, 'ESPORT');
INSERT INTO `game_types` VALUES (8, 'Other(其他)', 1, 'OTHER');
...
-- ----------------------------
-- 汇率配置表 (Exchange Rates)
-- ----------------------------
DROP TABLE IF EXISTS `exchange_rates`;
CREATE TABLE `exchange_rates` (
  `code` varchar(10) NOT NULL COMMENT '目标货币代码 (IDR, MYR, CNY)',
  `rate` decimal(20, 4) NOT NULL COMMENT '1美元兑换多少目标货币',
  `updated_at` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后修改时间',
  PRIMARY KEY (`code`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='每日汇率配置表';

-- 初始化数据 (管理员每天在后台修改这里)
INSERT INTO `exchange_rates` (`code`, `rate`) VALUES 
('IDR', 15500.0000),  -- 1 USD = 15,500 印尼盾
('MYR', 4.6500),      -- 1 USD = 4.65 马币
('RUB', 92.5000),     -- 1 USD = 92.5 卢布
('HKD', 7.8200);      -- 1 USD = 7.82 港币
